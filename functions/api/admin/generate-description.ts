...
const PROMPT_TEMPLATE = `You are writing SEO-friendly music descriptions for a premium royalty-free music library. Generate ONE short, natural English paragraph (60–90 words). Base the description ONLY on the provided Genre, Mood and Use Case. The description should: • immediately describe the feeling and atmosphere of the music • naturally mention suitable projects and use cases • sound like it was written by a professional music publisher • use clear, modern English • avoid exaggerated marketing language • avoid repeating the same adjective twice • never mention instruments unless they are strongly implied by the Genre • never invent a story or scene that contradicts the tags • never mention track names • never mention BPM, key or technical details • never use bullet points • never use quotation marks Include 3–6 natural use examples whenever appropriate, such as: film trailers movies TV documentaries commercials advertising sports technology video games cinematic intros YouTube podcasts presentations background music social media corporate videos Naturally include "royalty-free music" once whenever it fits the sentence. The result should sound similar to premium music libraries such as Artlist, PremiumBeat or Musicbed. Genre: <GENRE> Mood: <MOOD> Use Case: <USE_CASE>`;
