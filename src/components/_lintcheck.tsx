...
const AdminTracksEdit = ({
  ...
  return (
    <div className="mt-5 items-start gap-6 xl:grid xl:grid-cols-[minmax(0,1fr)_40rem]">
      ...
      <div className="min-w-0">
        ...
        <div className="mt-4 overflow-x-auto rounded-lg border border-border/60">
          <div className="min-w-[48rem]">
            <div className="grid grid-cols-[2.5rem_2.5rem_minmax(0,1fr)_9rem_5.5rem_6.5rem_6.5rem_6.5rem] items-center gap-2 border-b border-border/60 bg-secondary/40 px-3 py-2.5">
            ...
            {paged.map((t) => {
              ...
              return (
                <div
                  key={t.id}
                  className={`grid grid-cols-[2.5rem_2.5rem_minmax(0,1fr)_9rem_5.5rem_6.5rem_6.5rem_6.5rem] items-center gap-2 border-b border-border/40 px-3 py-2 transition-colors last:border-b-0 ${
