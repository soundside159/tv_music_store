      ...
      <div className="min-w-0">
        ...
        <div className="mt-4 overflow-x-auto rounded-lg border border-border/60">
          <div className="min-w-[42rem]">
            <div className="grid grid-cols-[2.5rem_2.5rem_minmax(0,1fr)_7rem_4.5rem_4.5rem_4.5rem_4rem] items-center gap-2 border-b border-border/60 bg-secondary/40 px-3 py-2.5">
              ...
              <span className="text-center font-body text-xs uppercase tracking-wide text-muted-foreground">Coll.</span>
              <span className="text-center font-body text-xs uppercase tracking-wide text-muted-foreground">Playl.</span>
              <span className="text-center font-body text-xs uppercase tracking-wide text-muted-foreground">Trend</span>
            </div>
            ...
            {paged.map((t) => {
              ...
              return (
                <div
                  key={t.id}
                  className={`grid grid-cols-[2.5rem_2.5rem_minmax(0,1fr)_7rem_4.5rem_4.5rem_4.5rem_4rem] items-center gap-2 border-b border-border/40 px-3 py-2 transition-colors last:border-b-0 ${
