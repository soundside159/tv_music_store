  ...
  <div className="min-h-screen bg-background">
    ...
    <main className="mx-auto w-full max-w-3xl px-4 pb-24 pt-28 sm:px-6 md:pt-32">
      ...
      <P>
        ...
        are licensed. A claim is a notice, not a copyright strike: it does not harm your channel. For
        licensed uses we send it for release.
      </P>
      <UL
        items={[
      ...
      />
      <P>
        <strong>What we commit to.</strong> Our commitment is the request: for any claim on a licensed
        use, reported through your account or by email, we submit the release within one business day.
        The release itself is executed inside YouTube's Content ID system by the rights holder's
        provider, and neither we nor anyone else can dictate YouTube's processing time — so we promise
        the part we control, and we do it fast. If a claim you reported is still open, write to us and
        we will chase it.
      </P>
      <P>
