...
- Текущий UI-курс: современный минимализм в стиле music library, графит/белый, без золотой/горчичной темы, компактные строки треков, версии внутри строки.
- Текущий каталог: слева фильтры Use Case / Genre / Mood, по центру список треков, waveform строится из реального MP3 и поддерживает click-to-seek.
